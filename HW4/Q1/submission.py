...
def author():
    return "lrajasekar3"  # replace gburdell3 with your Georgia Tech username.


def gtid():
    return 903616323  # replace with your GT ID number
...
class PageRank:
    ...
    def run_pagerank(self, node_weights, damping_factor=0.85, iterations=10):
        ...
        for it in range(iterations):
            ...
            pr_values =((1-dampling_factor)*node_weights)+(new_pr_values)
