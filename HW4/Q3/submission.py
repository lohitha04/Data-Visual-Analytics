...
class Data():
    ...
    def dataAllocation(self,path):
        ...
        y_data1=df_data.iloc[:,-1]
        y_data=y_data1.squeeze()
        # -------------------------------
...
class LinearRegressionModel():
    ...
    def lgTrainAccuracy(self,y_train,y_predict_train):
        ...
        train_accuracy=accuracy_score(y_train,np.where(y_predict_train>=0.5,1,0))
    ...
    def lgTestAccuracy(self,y_test,y_predict_test):
        ...
        # -------------------------------
        # ADD CODE HERE
        test_accuracy=accuracy_score(y_test,np.where(y_predict_test>=0.5,1,0))
...
# Q3.4.2 Classification
    ...
    def SVCClassifier(self,scaled_x_train,scaled_x_test, y_train):
        ...
        y_predict_train=sc.predict(scaled_x_train)
        y_predict_test=sc.predict(scaled_x_test)
        # -------------------------------
        return y_predict_train,y_predict_test
...
# Q3.4.3 Hyper-parameter Tuning
    ...
    def SVMBestScore(self, scaled_x_train, y_train):
        ...
        # ADD CODE HERE
        sc=SVC(gamma = 'auto')
        svm_cv=GridSearchCV(sc, svm_parameters,n_jobs = -1,return_train_score = True)
